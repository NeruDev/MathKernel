"""
Gráfico: Diagrama de Decisión - Método de Series de Potencias
=============================================================

Topic: ED-05 Series de Potencias
Usado en: methods/ED-05-Metodos-Series-Potencias.md (Diagrama de Decisión)

Diagrama de flujo para seleccionar el método de series de potencias
apropiado según la clasificación del punto.
"""
...
METADATA = {
    "topic_id": "ED-05",
    "name": "diagrama_decision_series_potencias",
    "description": "Diagrama de flujo para método de series de potencias",
    "used_in": [
        "methods/ED-05-Metodos-Series-Potencias.md"
    ],
    "section": "Diagrama de Decisión: Método de Series",
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama de decisión para series de potencias.
...
if __name__ == "__main__":
    fig = generate()
    output_dir = get_output_dir_for_topic("ED-05")
    paths = save_figure(fig, output_dir, METADATA['name'])
    print(f"✅ Gráfico guardado en: {paths}")
    plt.close(fig)
