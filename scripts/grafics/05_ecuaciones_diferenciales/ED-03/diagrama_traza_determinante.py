"""
Gráfico: Diagrama Traza-Determinante - Clasificación de Puntos de Equilibrio
============================================================================

Topic: ED-03 Sistemas de EDO
Usado en: methods/ED-03-Metodos-Sistemas-EDO.md (Método 7)

Diagrama del plano traza-determinante para clasificar puntos de equilibrio
de sistemas lineales de EDO.
"""
...
METADATA = {
    "topic_id": "ED-03",
    "name": "diagrama_traza_determinante",
    "description": "Diagrama de clasificación de puntos de equilibrio usando traza y determinante",
    "used_in": [
        "methods/ED-03-Metodos-Sistemas-EDO.md"
    ],
    "section": "Método 7: Clasificar Retrato de Fase",
}


def generate() -> plt.Figure:
    """
    Genera el diagrama traza-determinante para clasificación de equilibrios.
...
if __name__ == "__main__":
    fig = generate()
    output_dir = get_output_dir_for_topic("ED-03")
