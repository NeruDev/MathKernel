"""
Gráfico: Diagrama de Clasificación - EDO Segundo Orden
======================================================

Topic: ED-02 EDO de Segundo Orden
Usado en: methods/ED-02-Metodos-EDO-Segundo-Orden.md (Método 9)
...
METADATA = {
    "topic_id": "ED-02",
    "name": "diagrama_clasificacion_edo_segundo_orden",
    "description": "Diagrama de flujo para clasificar EDO de segundo orden",
    "used_in": [
        "methods/ED-02-Metodos-EDO-Segundo-Orden.md"
    ],
...
def generate() -> plt.Figure:
    """
    Genera el diagrama de clasificación para EDO de segundo orden.
...
if __name__ == "__main__":
    fig = generate()
    output_dir = get_output_dir_for_topic("ED-02")
