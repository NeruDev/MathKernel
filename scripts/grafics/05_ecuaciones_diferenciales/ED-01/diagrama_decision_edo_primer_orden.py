"""
Gráfico: Diagrama de Decisión - EDO Primer Orden
================================================

Topic: ED-01 EDO de Primer Orden
Usado en: methods/ED-01-Metodos-EDO-Primer-Orden.md (Método 9)

Diagrama de flujo para identificar el tipo de EDO de primer orden
y seleccionar el método de resolución apropiado.
"""
...
METADATA = {
    "topic_id": "ED-01",
    "name": "diagrama_decision_edo_primer_orden",
    "description": "Diagrama de flujo para identificar tipo de EDO de primer orden",
    "used_in": [
        "methods/ED-01-Metodos-EDO-Primer-Orden.md"
    ],
    "section": "Método 9: Identificar Tipo de Ecuación",
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama de decisión para EDO de primer orden.
...
if __name__ == "__main__":
    fig = generate()
    output_dir = get_output_dir_for_topic("ED-01")
