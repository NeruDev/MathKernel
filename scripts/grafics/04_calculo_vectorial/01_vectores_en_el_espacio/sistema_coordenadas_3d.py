"""
Gráfico: Sistema de Coordenadas 3D
==================================

Topic: CV-01 Vectores en el Espacio
Usado en: theory/CV-01-Teoria-Vectores.md (Sección 1.1)

Sistema de coordenadas cartesianas tridimensional con vectores canónicos.
"""
...
METADATA = {
    "topic_id": "CV-01",
    "name": "sistema_coordenadas_3d",
    "description": "Sistema de coordenadas cartesianas 3D con vectores canónicos i, j, k",
    "used_in": ["theory/CV-01-Teoria-Vectores.md"],
    "section": "1.1 Definición de un vector en el espacio",
}

def generate() -> plt.Figure:
    """Genera el diagrama del sistema de coordenadas 3D."""
    setup_style()
    colors = get_colors()
