"""
Gráfico: Producto Punto y Producto Cruz
=======================================

Topic: CV-01 Vectores en el Espacio
Usado en: theory/CV-01-Teoria-Vectores.md (Sección 1.3)

Visualización del producto escalar y producto vectorial.
"""
...
METADATA = {
    "topic_id": "CV-01",
    "name": "producto_punto_cruz",
    "description": "Producto escalar (punto) y producto vectorial (cruz)",
    "used_in": ["theory/CV-01-Teoria-Vectores.md"],
    "section": "1.3 Producto escalar y vectorial",
}

def generate() -> plt.Figure:
    """Genera el diagrama del producto punto y cruz."""
    setup_style()
    colors = get_colors()
