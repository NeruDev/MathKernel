"""
Gráfico: Recta y Plano en el Espacio
====================================

Topic: CV-01 Vectores en el Espacio
Usado en: theory/CV-01-Teoria-Vectores.md (Secciones 1.4 y 1.5)

Ecuaciones de recta y plano en R³.
"""
...
METADATA = {
    "topic_id": "CV-01",
    "name": "recta_plano_espacio",
    "description": "Ecuación de la recta y el plano en el espacio 3D",
    "used_in": ["theory/CV-01-Teoria-Vectores.md"],
    "section": "1.4-1.5 Ecuación de la recta y del plano",
}

def generate() -> plt.Figure:
    """Genera el diagrama de recta y plano en el espacio."""
    setup_style()
    colors = get_colors()
