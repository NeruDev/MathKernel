"""
Gráfico: Superficies y Funciones de Dos Variables
=================================================

Topic: CV-04 Funciones de Varias Variables
Usado en: theory/CV-04-Teoria-Varias.md (Sección 4.1)

Superficie z=f(x,y) con dominio y rango.
"""
...
METADATA = {
    "topic_id": "CV-04",
    "name": "superficie_funcion_dos_variables",
    "description": "Superficie z=f(x,y), dominio y rango",
    "used_in": ["theory/CV-04-Teoria-Varias.md"],
    "section": "4.1 Funciones de varias variables",
}

def generate() -> plt.Figure:
    """Genera el diagrama de superficie y función de dos variables."""
    setup_style()
    colors = get_colors()
