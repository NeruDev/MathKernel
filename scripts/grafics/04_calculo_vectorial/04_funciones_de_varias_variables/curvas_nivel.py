"""
Gráfico: Curvas de Nivel y Mapa de Contorno
===========================================

Topic: CV-04 Funciones de Varias Variables
Usado en: theory/CV-04-Teoria-Varias.md (Sección 4.2)

Curvas de nivel f(x,y) = c y su relación con la superficie.
"""
...
METADATA = {
    "topic_id": "CV-04",
    "name": "curvas_nivel",
    "description": "Curvas de nivel y mapa de contorno",
    "used_in": ["theory/CV-04-Teoria-Varias.md"],
    "section": "4.2 Curvas de nivel",
}

def generate() -> plt.Figure:
    """Genera el diagrama de curvas de nivel."""
    setup_style()
    colors = get_colors()
