"""
Gráfico: Plano Tangente y Aproximación Lineal
=============================================

Topic: CV-04 Funciones de Varias Variables
Usado en: theory/CV-04-Teoria-Varias.md (Sección 4.4)

Plano tangente a una superficie y aproximación lineal.
"""
...
METADATA = {
    "topic_id": "CV-04",
    "name": "plano_tangente",
    "description": "Plano tangente y aproximación lineal",
    "used_in": ["theory/CV-04-Teoria-Varias.md"],
    "section": "4.4 Plano tangente",
}

def generate() -> plt.Figure:
    """Genera el diagrama de plano tangente."""
    setup_style()
    colors = get_colors()
