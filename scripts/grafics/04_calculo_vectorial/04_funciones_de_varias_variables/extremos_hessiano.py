"""
Gráfico: Extremos y Criterio del Hessiano
=========================================

Topic: CV-04 Funciones de Varias Variables
Usado en: theory/CV-04-Teoria-Varias.md (Sección 4.8)
...
METADATA = {
    "topic_id": "CV-04",
    "name": "extremos_hessiano",
    "description": "Puntos críticos y criterio de la segunda derivada",
    "used_in": ["theory/CV-04-Teoria-Varias.md"],
    "section": "4.8 Extremos de funciones de varias variables",
}

def generate() -> plt.Figure:
    """Genera el diagrama de extremos y Hessiano."""
    setup_style()
    colors = get_colors()
