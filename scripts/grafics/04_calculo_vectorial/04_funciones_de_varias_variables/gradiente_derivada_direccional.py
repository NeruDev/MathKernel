"""
Gráfico: Gradiente y Derivada Direccional
=========================================

Topic: CV-04 Funciones de Varias Variables
Usado en: theory/CV-04-Teoria-Varias.md (Sección 4.5)

Gradiente, derivada direccional y su relación geométrica.
"""
...
METADATA = {
    "topic_id": "CV-04",
    "name": "gradiente_derivada_direccional",
    "description": "Gradiente y derivada direccional",
    "used_in": ["theory/CV-04-Teoria-Varias.md"],
    "section": "4.5 Gradiente",
}

def generate() -> plt.Figure:
    """Genera el diagrama de gradiente y derivada direccional."""
    setup_style()
    colors = get_colors()
