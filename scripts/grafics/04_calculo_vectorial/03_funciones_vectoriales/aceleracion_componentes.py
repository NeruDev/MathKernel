"""
Gráfico: Componentes de la Aceleración
======================================

Topic: CV-03 Funciones Vectoriales
Usado en: theory/CV-03-Teoria-Vectoriales.md (Sección 3.8)
...
METADATA = {
    "topic_id": "CV-03",
    "name": "aceleracion_componentes",
    "description": "Componentes tangencial y normal de la aceleración",
    "used_in": ["theory/CV-03-Teoria-Vectoriales.md"],
    "section": "3.8 Componentes de la aceleración",
}

def generate() -> plt.Figure:
    """Genera el diagrama de componentes de aceleración."""
    setup_style()
    colors = get_colors()
