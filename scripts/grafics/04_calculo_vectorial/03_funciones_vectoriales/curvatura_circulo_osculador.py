"""
Gráfico: Curvatura y Radio de Curvatura
=======================================

Topic: CV-03 Funciones Vectoriales
Usado en: theory/CV-03-Teoria-Vectoriales.md (Sección 3.7)

Curvatura, círculo osculador y centro de curvatura.
"""
...
METADATA = {
    "topic_id": "CV-03",
    "name": "curvatura_circulo_osculador",
    "description": "Curvatura, radio de curvatura y círculo osculador",
    "used_in": ["theory/CV-03-Teoria-Vectoriales.md"],
    "section": "3.7 Curvatura",
}

def generate() -> plt.Figure:
    """Genera el diagrama de curvatura y círculo osculador."""
    setup_style()
    colors = get_colors()
