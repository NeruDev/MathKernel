"""
Gráfico: Longitud de Arco y Reparametrización
=============================================

Topic: CV-03 Funciones Vectoriales
Usado en: theory/CV-03-Teoria-Vectoriales.md (Sección 3.5)

Longitud de arco como función y reparametrización.
"""
...
METADATA = {
    "topic_id": "CV-03",
    "name": "longitud_arco",
    "description": "Longitud de arco como parámetro y reparametrización",
    "used_in": ["theory/CV-03-Teoria-Vectoriales.md"],
    "section": "3.5 Longitud de arco",
}

def generate() -> plt.Figure:
    """Genera el diagrama de longitud de arco."""
    setup_style()
    colors = get_colors()
