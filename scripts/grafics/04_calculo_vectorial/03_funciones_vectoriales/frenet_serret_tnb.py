"""
Gráfico: Marco de Frenet-Serret (TNB)
=====================================

Topic: CV-03 Funciones Vectoriales
Usado en: theory/CV-03-Teoria-Vectoriales.md (Sección 3.6)

Vectores tangente, normal y binormal en una curva.
"""
...
METADATA = {
    "topic_id": "CV-03",
    "name": "frenet_serret_tnb",
    "description": "Marco de Frenet-Serret: vectores T, N, B",
    "used_in": ["theory/CV-03-Teoria-Vectoriales.md"],
    "section": "3.6 Marco de Frenet-Serret (TNB)",
}

def generate() -> plt.Figure:
    """Genera el diagrama del marco TNB."""
    setup_style()
    colors = get_colors()
