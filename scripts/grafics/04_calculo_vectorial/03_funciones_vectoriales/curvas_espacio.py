"""
Gráfico: Curvas en el Espacio
=============================

Topic: CV-03 Funciones Vectoriales
Usado en: theory/CV-03-Teoria-Vectoriales.md (Sección 3.1)

Funciones vectoriales y curvas paramétricas en R³.
"""
...
METADATA = {
    "topic_id": "CV-03",
    "name": "curvas_espacio",
    "description": "Funciones vectoriales r(t) y curvas en el espacio",
    "used_in": ["theory/CV-03-Teoria-Vectoriales.md"],
    "section": "3.1 Definición y representación",
}

def generate() -> plt.Figure:
    """Genera el diagrama de curvas en el espacio."""
    setup_style()
    colors = get_colors()
