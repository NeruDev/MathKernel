...
Usado en: theory/CV-05-Teoria-Integracion.md (Sección 5.5)

Sistema de coordenadas esféricas (ρ, θ, φ).
"""
...
METADATA = {
    "topic_id": "CV-05",
    "name": "coordenadas_esfericas",
    "description": "Sistema de coordenadas esféricas",
    "used_in": ["theory/CV-05-Teoria-Integracion.md"],
    "section": "5.5 Coordenadas esféricas",
}

def generate() -> plt.Figure:
    """Genera el diagrama de coordenadas esféricas."""
    setup_style()
    colors = get_colors()
