"""
Gráfico: Teoremas de Green, Stokes y Divergencia
================================================

Topic: CV-05 Integración Múltiple
Usado en: theory/CV-05-Teoria-Integracion.md (Sección 5.7)

Ilustración de los teoremas fundamentales del cálculo vectorial.
"""
...
METADATA = {
    "topic_id": "CV-05",
    "name": "teoremas_integrales",
    "description": "Teoremas de Green, Stokes y Divergencia",
    "used_in": ["theory/CV-05-Teoria-Integracion.md"],
    "section": "5.7 Teoremas fundamentales",
}

def generate() -> plt.Figure:
    """Genera el diagrama de los teoremas integrales."""
    setup_style()
    colors = get_colors()
