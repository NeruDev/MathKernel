"""
Gráfico: Regiones de Integración Doble
======================================

Topic: CV-05 Integración Múltiple
Usado en: theory/CV-05-Teoria-Integracion.md (Sección 5.1)

Regiones Tipo I y Tipo II para integrales dobles.
"""
...
METADATA = {
    "topic_id": "CV-05",
    "name": "regiones_integracion_doble",
    "description": "Regiones Tipo I y Tipo II",
    "used_in": ["theory/CV-05-Teoria-Integracion.md"],
    "section": "5.1 Integrales dobles",
}

def generate() -> plt.Figure:
    """Genera el diagrama de regiones de integración."""
    setup_style()
    colors = get_colors()
