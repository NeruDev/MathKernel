"""
Gráfico: Coordenadas Cilíndricas
================================

Topic: CV-05 Integración Múltiple
Usado en: theory/CV-05-Teoria-Integracion.md (Sección 5.4)

Sistema de coordenadas cilíndricas (r, θ, z).
"""
...
METADATA = {
    "topic_id": "CV-05",
    "name": "coordenadas_cilindricas",
    "description": "Sistema de coordenadas cilíndricas",
    "used_in": ["theory/CV-05-Teoria-Integracion.md"],
    "section": "5.4 Coordenadas cilíndricas",
}

def generate() -> plt.Figure:
    """Genera el diagrama de coordenadas cilíndricas."""
    setup_style()
    colors = get_colors()
