"""
Gráfico: Ángulos en la Circunferencia
=====================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "circunferencia_angulos",
    "description": "Tipos de ángulos: central, inscrito, semi-inscrito",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.6",
}

def draw_circle_with_angle(ax, angle_type, colors_dict):
    """Dibuja una circunferencia con un tipo de ángulo."""
    # Circunferencia
...
def generate() -> plt.Figure:
    """Genera el gráfico de ángulos en la circunferencia."""
    setup_style()
    colors = get_colors()
