"""
Gráfico: Ángulos Complementarios y Suplementarios
=================================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "angulos_complementarios_suplementarios",
    "description": "Ángulos complementarios (90°) y suplementarios (180°)",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.2",
}

def generate() -> plt.Figure:
    """Genera el gráfico de ángulos complementarios y suplementarios."""
    setup_style()
    colors = get_colors()
