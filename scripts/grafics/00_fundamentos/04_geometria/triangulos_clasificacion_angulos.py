"""
Gráfico: Clasificación de Triángulos por Ángulos
================================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "triangulos_clasificacion_angulos",
    "description": "Clasificación de triángulos: acutángulo, rectángulo, obtusángulo",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.3",
}

def draw_angle_arc(ax, vertex, p1, p2, radius, color, show_right=False):
    """Dibuja el arco de un ángulo."""
...
def generate() -> plt.Figure:
    """Genera el gráfico de clasificación de triángulos por ángulos."""
    setup_style()
    colors = get_colors()
