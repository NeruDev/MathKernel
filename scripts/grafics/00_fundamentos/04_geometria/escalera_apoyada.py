"""
Gráfico: Escalera Apoyada (Aplicación Pitágoras)
================================================

Topic: FUN-04 Geometría
Usado en: problems/FUN-04-Problemas.md (Prob-85)
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "escalera_apoyada",
    "description": "Problema de escalera apoyada - aplicación del teorema de Pitágoras",
    "used_in": ["problems/FUN-04-Problemas.md"],
    "section": "4.9",
}

def generate() -> plt.Figure:
    """Genera el gráfico de la escalera apoyada."""
    setup_style()
    colors = get_colors()
