"""
Gráfico: Trapecio - Elementos y Fórmulas
========================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "trapecio_elementos",
    "description": "Trapecio con bases, altura, mediana y fórmulas",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md", "problems/FUN-04-Problemas.md"],
    "section": "4.4",
}

def generate() -> plt.Figure:
    """Genera el gráfico del trapecio con elementos."""
    setup_style()
    colors = get_colors()
