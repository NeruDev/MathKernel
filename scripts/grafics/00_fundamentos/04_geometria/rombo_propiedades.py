"""
Gráfico: Rombo - Diagonales y Propiedades
=========================================

Topic: FUN-04 Geometría
Usado en: problems/FUN-04-Problemas.md (Prob-33, Prob-65, Prob-88)
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "rombo_propiedades",
    "description": "Rombo con diagonales, perpendiculares y fórmulas",
    "used_in": ["problems/FUN-04-Problemas.md"],
    "section": "4.4",
}

def generate() -> plt.Figure:
    """Genera el gráfico del rombo con propiedades."""
    setup_style()
    colors = get_colors()
