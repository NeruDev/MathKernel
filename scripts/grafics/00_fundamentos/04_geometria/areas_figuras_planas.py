"""
Gráfico: Fórmulas de Áreas de Figuras Planas
============================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "areas_figuras_planas",
    "description": "Fórmulas de área: cuadrado, rectángulo, triángulo, paralelogramo, trapecio, círculo",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.7",
}

def generate() -> plt.Figure:
    """Genera el gráfico de fórmulas de áreas."""
    setup_style()
    colors = get_colors()
