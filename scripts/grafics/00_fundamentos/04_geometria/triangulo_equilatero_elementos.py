"""
Gráfico: Triángulo Equilátero - Elementos
=========================================

Topic: FUN-04 Geometría
Usado en: problems/FUN-04-Problemas.md (Prob-24)
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "triangulo_equilatero_elementos",
    "description": "Triángulo equilátero con altura, radio inscrito y circunscrito",
    "used_in": ["problems/FUN-04-Problemas.md"],
    "section": "4.3",
}

def generate() -> plt.Figure:
    """Genera el gráfico del triángulo equilátero con sus elementos."""
    setup_style()
    colors = get_colors()
