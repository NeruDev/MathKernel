"""
Gráfico: Triángulo con Altura y Fórmula de Área
===============================================

Topic: FUN-04 Geometría
Usado en: theory/FUN-04-Teoria-Geometria.md (Sección 4.7)

Ilustra la fórmula del área del triángulo: A = (b × h) / 2
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "triangulo_altura_area",
    "description": "Triángulo con altura marcada ilustrando la fórmula del área",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md", "methods/FUN-04-Metodos-Geometria.md"],
    "section": "4.7 Áreas de figuras planas",
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama del triángulo con altura.
