"""
Gráfico: Sólidos Geométricos (Geometría del Espacio)
====================================================

Topic: FUN-04 Geometría
Usado en: theory/FUN-04-Teoria-Geometria.md (sección 4.10)
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "solidos_geometricos",
    "description": "Sólidos: prisma, pirámide, cilindro, cono, esfera",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.10",
}

def generate() -> plt.Figure:
    """Genera el gráfico de sólidos geométricos."""
    setup_style()
    colors = get_colors()
