"""
Gráfico: Elementos de la Circunferencia
=======================================

Topic: FUN-04 Geometría
Usado en: theory/FUN-04-Teoria-Geometria.md (Sección 4.6)

Muestra todos los elementos principales de una circunferencia:
radio, diámetro, cuerda, arco, tangente, secante.
"""
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "circunferencia_elementos",
    "description": "Elementos principales de la circunferencia: radio, diámetro, cuerda, tangente",
    "used_in": ["theory/FUN-04-Teoria-Geometria.md"],
    "section": "4.6 Circunferencia y círculo",
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama con elementos de la circunferencia.
