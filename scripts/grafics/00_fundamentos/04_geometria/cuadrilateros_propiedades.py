"""
Gráfico: Propiedades de Cuadriláteros Especiales
================================================
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "cuadrilateros_propiedades",
    "description": "Propiedades de paralelogramo, rectángulo, rombo, cuadrado",
...
def draw_quadrilateral(ax, vertices, color, show_diagonals=True, 
    ...
    """Dibuja un cuadrilátero con sus propiedades."""
...
def generate() -> plt.Figure:
    """Genera el gráfico de propiedades de cuadriláteros especiales."""
    setup_style()
    colors = get_colors()
