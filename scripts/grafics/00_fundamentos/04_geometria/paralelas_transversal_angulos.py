"""
Gráfico: Ángulos entre Rectas Paralelas con Transversal
=======================================================

Topic: FUN-04 Geometría
Usado en: problems/FUN-04-Problemas.md (Prob-13)

Reemplaza el diagrama ASCII:
```
       ∠1
    ____/____ ℓ₁
         \
...
METADATA = {
    "topic_id": "FUN-04",
    "name": "paralelas_transversal_angulos",
    "description": "Dos rectas paralelas cortadas por una transversal mostrando ángulos",
    "used_in": ["problems/FUN-04-Problemas.md"],
    "section": "4.2 Ángulos - Prob-13",
    "replaces_ascii": True,
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama de paralelas con transversal.
