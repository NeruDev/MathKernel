...
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.6)

Elipse con elementos principales.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "elipse",
    "description": "La elipse: elementos, ecuaciones y propiedades",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.6 La elipse",
}

def generate() -> plt.Figure:
    """Genera el diagrama de la elipse."""
    setup_style()
    colors = get_colors()
