"""
Gráfico: Transformaciones Geométricas
=====================================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.10)

Traslación, rotación, reflexión y escalamiento.
"""
...
METADATA = {
    ...
    "description": "Transformaciones geométricas: traslación, rotación, reflexión, escalamiento",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.10 Transformaciones geométricas",
}

def generate() -> plt.Figure:
    """Genera el diagrama de transformaciones geométricas."""
    setup_style()
    colors = get_colors()
