"""
Gráfico: Pendiente y Formas de la Ecuación de la Recta
======================================================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.3)

Visualización de pendiente y diferentes formas de la ecuación de la recta.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "pendiente_recta",
    "description": "Pendiente y ecuaciones de la línea recta",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.3 La línea recta",
}

def generate() -> plt.Figure:
    """Genera el diagrama de pendiente y rectas."""
    setup_style()
    colors = get_colors()
