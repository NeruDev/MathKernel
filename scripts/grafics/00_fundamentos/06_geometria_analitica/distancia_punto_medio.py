"""
Gráfico: Fórmulas Fundamentales - Distancia y Punto Medio
=========================================================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.2)

Visualización de distancia entre puntos y punto medio.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "distancia_punto_medio",
    "description": "Fórmulas de distancia entre puntos y punto medio",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.2 Fórmulas fundamentales",
}

def generate() -> plt.Figure:
    """Genera el diagrama de distancia y punto medio."""
    setup_style()
    colors = get_colors()
