"""
Gráfico: Clasificación de Cónicas por Discriminante
===================================================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.8)

Ecuación general de segundo grado y clasificación mediante el discriminante.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "conicas_discriminante",
    "description": "Clasificación de cónicas mediante el discriminante B²-4AC",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.8 Ecuación general de segundo grado",
}

def generate() -> plt.Figure:
    """Genera el diagrama de clasificación de cónicas."""
    setup_style()
    colors = get_colors()
