...
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.9)

Sistema de coordenadas polares y conversión a cartesianas.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "coordenadas_polares",
    "description": "Coordenadas polares y conversión cartesiana-polar",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.9 Coordenadas polares",
}

def generate() -> plt.Figure:
    """Genera el diagrama de coordenadas polares."""
    setup_style()
    colors = get_colors()
