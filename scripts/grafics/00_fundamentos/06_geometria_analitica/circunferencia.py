"""
Gráfico: La Circunferencia
==========================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.4)

Circunferencia con elementos y ecuaciones.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "circunferencia",
    "description": "La circunferencia: elementos y ecuaciones",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.4 La circunferencia",
}

def generate() -> plt.Figure:
    """Genera el diagrama de la circunferencia."""
    setup_style()
    colors = get_colors()
