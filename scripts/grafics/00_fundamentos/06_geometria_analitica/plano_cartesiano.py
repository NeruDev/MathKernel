"""
Gráfico: Sistema de Coordenadas Cartesianas
===========================================

Topic: FUN-06 Geometría Analítica
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.1)

Muestra el plano cartesiano con cuadrantes y puntos de ejemplo.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "plano_cartesiano",
    "description": "Sistema de coordenadas cartesianas con cuadrantes",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.1 Sistema de coordenadas cartesianas",
}

def generate() -> plt.Figure:
    """Genera el diagrama del plano cartesiano."""
    setup_style()
    colors = get_colors()
