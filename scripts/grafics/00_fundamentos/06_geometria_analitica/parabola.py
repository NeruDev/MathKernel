...
Usado en: theory/FUN-06-Teoria-Geometria-Analitica.md (Sección 6.5)

Parábola con elementos principales.
"""
...
METADATA = {
    "topic_id": "FUN-06",
    "name": "parabola",
    "description": "La parábola: elementos, ecuaciones y orientaciones",
    "used_in": ["theory/FUN-06-Teoria-Geometria-Analitica.md"],
    "section": "6.5 La parábola",
}

def generate() -> plt.Figure:
    """Genera el diagrama de la parábola."""
    setup_style()
    colors = get_colors()
