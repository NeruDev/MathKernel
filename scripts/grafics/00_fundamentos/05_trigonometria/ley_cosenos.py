"""
Gráfico: Ley de Cosenos
=======================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.8)

Visualización de la ley de cosenos en un triángulo oblicuángulo.
"""
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "ley_cosenos",
    "description": "Ley de cosenos para resolución de triángulos oblicuángulos",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.8 Resolución de triángulos - Ley de cosenos",
}

def generate() -> plt.Figure:
    """Genera el diagrama de la ley de cosenos."""
    setup_style()
    colors = get_colors()
