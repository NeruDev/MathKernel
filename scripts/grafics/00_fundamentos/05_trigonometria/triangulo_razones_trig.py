"""
Gráfico: Razones Trigonométricas en Triángulo Rectángulo
========================================================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.2)

Muestra las razones trigonométricas básicas en un triángulo rectángulo.
"""
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "triangulo_razones_trig",
    "description": "Razones trigonométricas en triángulo rectángulo: SOH-CAH-TOA",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.2 Razones trigonométricas",
}
...
def generate() -> plt.Figure:
    """
    Genera el diagrama de razones trigonométricas.
    
    Returns:
        Figura de matplotlib con GridSpec.
    """
    setup_style()
    colors = get_colors()
