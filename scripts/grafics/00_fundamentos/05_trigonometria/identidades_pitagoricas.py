"""
Gráfico: Identidades Pitagóricas
================================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.4)

Visualización de las identidades pitagóricas y su derivación.
"""
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "identidades_pitagoricas",
    "description": "Las tres identidades pitagóricas fundamentales",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.4 Identidades pitagóricas",
}

def generate() -> plt.Figure:
    """Genera el diagrama de identidades pitagóricas."""
    setup_style()
    colors = get_colors()
