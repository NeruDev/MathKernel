"""
Gráfico: Transformaciones de Funciones Trigonométricas
======================================================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.11)

Muestra amplitud, periodo y desfase en funciones trigonométricas.
"""
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "transformaciones_trig",
    "description": "Transformaciones de funciones trigonométricas: amplitud, periodo, desfase",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.11 Gráficas de funciones trigonométricas",
}

def generate() -> plt.Figure:
    """Genera las gráficas de transformaciones."""
    setup_style()
    colors = get_colors()
