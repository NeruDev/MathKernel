"""
Gráfico: Gráficas de Funciones Seno y Coseno
============================================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.11)

Gráficas básicas de seno y coseno con sus características.
"""
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "graficas_seno_coseno",
    "description": "Gráficas de las funciones seno y coseno",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.11 Gráficas de funciones trigonométricas",
}

def generate() -> plt.Figure:
    """Genera las gráficas de seno y coseno."""
    setup_style()
    colors = get_colors()
