"""
Gráfico: Identidades de Ángulo Doble y Medio
============================================

Topic: FUN-05 Trigonometría
Usado en: theory/FUN-05-Teoria-Trigonometria.md (Sección 5.6)
...
METADATA = {
    "topic_id": "FUN-05",
    "name": "identidades_angulo_doble",
    "description": "Identidades de ángulo doble y medio ángulo",
    "used_in": ["theory/FUN-05-Teoria-Trigonometria.md"],
    "section": "5.6 Identidades de ángulo doble y medio ángulo",
}

def generate() -> plt.Figure:
    """Genera el diagrama de identidades de ángulo doble."""
    setup_style()
    colors = get_colors()
